...
//Creating the Database Schema (which data is entered to the database).
...
const ProductSchema = mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ["Approved", "Rejected"], //Predefined set of values
    },
  },

  {
    timestamps: true, //Getting time stamps(createdAt, updatedAt)
  }
);
