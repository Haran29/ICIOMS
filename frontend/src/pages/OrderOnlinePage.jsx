          ...
          .map((item) => (
            ...
            >
              <img
                src={item.image}
                alt={item.name}
                className="w-150 h-150 mb-2 object-cover rounded-lg"
              ...
              <button
                ...
                className="px-4 py-2 mt-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:bg-green-700"
                style={{ width: "150px" }}
              >
                Add to Cart
              </button>
