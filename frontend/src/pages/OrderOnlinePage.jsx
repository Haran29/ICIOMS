              ...
              >
                ...
                {item.quantity > 0 ? (
                  <div className="flex items-center absolute bottom-2 right-2">
                    ...
                    <p className="text-gray-800 text-xs mr-1">{item.quantity}</p>
                    <button
                  ...
                  <button
                    onClick={() => addToCart(item._id)}
                    className="px-3 py-1 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:bg-green-700 text-sm absolute bottom-2 right-2"
                  >
                    Add
                  </button>
                )}
